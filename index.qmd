...
format:
  revealjs:
    ...
    footer: "Registos Electrónicos de Saúde · SauD InoB · FMUP"
---
...
Criar o **menor ficheiro `.zip` possível** a partir de uma pasta com ficheiros de imagem, áudio, vídeo e um CSV clínico simulado.
...
- Download dos ficheiros: [exercicio.zip](ficheiros/exercicio.zip)
:::
:::
